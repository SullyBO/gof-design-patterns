...
interface ChatMediator {
    fun sendMessage(message: String, sender: Chatter)
    fun addUser(user: Chatter)
}

interface Chatter {
    val name: String
    fun receive(message: String, fromUser: String)
}
...
class ChatUser(
    ...
    override fun receive(message: String, fromUser: String) {
...
class ChatRoom : ChatMediator {
    ...
    override fun sendMessage(message: String, sender: Chatter) {
        users
            .filter { it != sender }
