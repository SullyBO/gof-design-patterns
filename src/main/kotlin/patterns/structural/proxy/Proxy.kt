...
val client: GitHubClient by lazy { GitHubClient() }
...
class GitHubClient : GitHubApiClient {
    override fun fetchUserRepos(request: String): String {
        ...
        return """
        [{"name":"gof-design-patterns","url":"https://github.com/user/gof-design-patterns"},
        {"name":"uma_statue_calculator","url":"https://github.com/user/uma_statue_calculator"}]
        """
    }
